...
//   " final " it can not change or update
    ...
    static String getDateTimeLogout() {
		
		DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm");
		Date date = new Date(System.currentTimeMillis());
		System.out.println("Logout Time : " + date );
...
//		use Update query and ResultSets for showing
		...
		String sqlQueryToUpdate = "UPDATE Hotel SET hotelName = " + "'" + hotelName + "'" + ", hotelLocation = "
				+ "'" + hotelLocation + "'," + " updated_date = " + "'" + new Date(System.currentTimeMillis()) + "' WHERE hotelId =" + userInput;
...
//				String hotelName1 = resultSet.getString("hotelName");
//				String hotelLocation1 = resultSet.getString("hotelLocation");
//				Date createdDate = resultSet.getDate("created_date");
//				Date updatedDate = resultSet.getDate("updated_date");
//				Boolean isActive = resultSet.getBoolean("is_Active");
//				System.out.println(hotelId + " " + hotelName1 + " " + hotelLocation1 + " " + createdDate + " " + updatedDate
//						+ " " + isActive);
//			}
//            closingConnection();
		} catch (Exception ex) {
...
//		use Delete query
		...
		try {
			...
			while (resultSet.next()) {
				...
				Date updatedDate = resultSet.getDate("updated_date");
				Boolean isActive = resultSet.getBoolean("is_Active");
				System.out.println(hotelId + " " + hotelName + " " + hotelLocation + " " + createdDate + " " + updatedDate
						+ " " + isActive);
			}
//            closingConnection();
		} catch (Exception ex) {
...
//		int userInput = inputScanner.nextInt();
//		String sqlQueryToSelect = "SELECT TOP " + userInput + " hotelId FROM Hotel";
//		Statement statement;
...
//			
//			
//			System.out.println(" 1 to active 0 to disActive ");
//			int i1 = sc.nextInt();
//			
//
//			if(i1!=0 ) {
